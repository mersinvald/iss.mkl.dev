...
translations:
  ru:
    shortDescription: "Луна — единственный естественный спутник Земли."
    description: |
      Луна — единственный естественный спутник Земли и пятый по величине спутник в Солнечной системе. Это самый яркий объект на ночном небе, хотя его поверхность на самом деле довольно тёмная, с отражательной способностью, лишь немного выше, чем у старого асфальта.

      Луна находится в синхронном вращении с Землёй, всегда показывая одну и ту же сторону нашей планете. Гравитационное влияние Луны вызывает океанские приливы и постепенно замедляет вращение Земли.

      Поверхность Луны покрыта кратерами, образовавшимися в результате столкновений с астероидами и кометами на протяжении миллиардов лет. Тёмные области, видимые с Земли, называются морями (maria) — это древние базальтовые равнины, образовавшиеся в результате вулканической активности.
---

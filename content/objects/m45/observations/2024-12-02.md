...
translations:
  ru:
    notes: |
      ...
      Использовал очень быструю экспозицию: 1,5 секунды с ~200 кадрами, ~150 пригодных. <br />
      В ту же ночь, что и съёмка Андромеды, также взял только тёмные кадры, без биасов и флэтов. <br />
      Немного лучшая обработка, чем у Андромеды, но всё ещё очень шумно: вероятно, попробую переобработать с PixInsight и обновлю описание, если перезагружу. <br />
      Но! Можно даже увидеть слабую туманность скопления, ура!
notes: |
